...
public sealed partial class SoundList
{
    ...
    public SoundList([FromKeyedServices(UserData.General)] UserData data, FilePicker filePicker, SettingsManager settingsManager, IClassicDesktopStyleApplicationLifetime? lifetime, SoundEditingContext editor, AudioManager audioManager)
    {
        _data = data;
